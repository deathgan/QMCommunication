...
namespace QMCommunication.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update QMCommunicationDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update QMCommunicationEfCoreEntityExtensionMappings to extend the IdentityUser entity
